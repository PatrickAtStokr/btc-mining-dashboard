...
Fetches recent market data and uses the Anthropic API to generate
...
Required env vars:
  ANTHROPIC_API_KEY  — Anthropic API key (stored as GitHub secret)
"""
...
- If data for a chart is unavailable, write a generic but useful contextual note"""
    ...
    print("Calling Anthropic API for chart signals...")
